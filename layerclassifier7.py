...
file_path = r"D:\desktop\毕设材料\7\fingerprint7_noisy.xlsx"
...
# 提取特征(6个TOA值)和标签
X = data.iloc[:, 3:10].values  # 第4到9列作为特征 (索引从0开始，所以是3到8)
...
plt.title('Confusion Matrix - 7 TOA (Cross-Validation)')
...
# 保存到新的Excel文件
output_path = r"D:\desktop\毕设材料\7\outputclassifier7_noisy.xlsx"
